    ...
    <div class="at-layout">
        <div class="at-tool-container">
            ...
            <div class="at-tool-body">
                <p>Hello, Sun Devils! Navigating your academic journey at Arizona State University can be a lot easier when you know exactly where you stand. Our free **ASU GPA calculator** is the perfect tool to help you track your grades and stay on course for success.</p>
        ...
        <div class="at-sidebar">
            ...
            <div class="at-related-card">
                ...
                <ul>
                    ...
                    <li><a href="/us/calculators/education/gpa-calculator-ucsd"><i class="fas fa-graduation-cap"></i>UCSD GPA Calculator</a></li>
        ...
        <div class="at-info-content">
            ...
            <div class="at-info-body">
                ...
                <ul>
                    ...
                    <li>**Withdrawal Deadline:** The last day to withdraw from a course without receiving a penalty.</li>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function createCourseRow() {
            ...
            row.innerHTML = `
                <input type="text" class="at-input course-name" placeholder="Course Name (e.g., MAT 270)">
